...
[role="quick-margin-para"]
Esta etapa é opcional. Você pode usar o Workload Factory sem adicionar credenciais para acessar sua conta AWS. Adicionar credenciais da AWS ao Workload Factory concede à sua conta Workload Factory as permissões necessárias para criar e gerenciar sistemas de arquivos FSx for ONTAP e para implantar e gerenciar cargas de trabalho específicas, como bancos de dados.
