...
---
= Capacidades de carga de trabalho no NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* https://docs.netapp.com/us-en/workload-eda/index.html["Cargas de trabalho de EDA"^]
+
Otimize o FSx para ONTAP em vários sistemas de arquivos para aumentar o desempenho e reduzir os custos operacionais por meio do gerenciamento automatizado de parâmetros de armazenamento.
