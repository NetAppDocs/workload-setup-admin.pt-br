...
* https://docs.netapp.com/us-en/workload-builders/index.html["cargas de trabalho do construtor"^]
+
Simplifique o consumo e o acesso às versões de software, permitindo a integração instantânea de clones com sistemas de controle de versão e fluxos de CI/CD, economizando tempo e recursos.
