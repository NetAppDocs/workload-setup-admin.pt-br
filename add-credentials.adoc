...
. Para os recursos de workload que oferecem a opção de níveis de permissão (leitura ou automação), selecione o tipo de permissões que estarão disponíveis com essas credenciais.
